...
class Videos_Posted(models.Model):
    ...
    category_video = models.ForeignKey(Category, on_delete=models.CASCADE,
    ...
    video_saved = models.ManyToManyField(User, related_name="video_saved",
                                         blank=True)
    video_liked = models.ManyToManyField(User, related_name="video_liked",
                                         blank=True)
...
class Comments(models.Model):
    author = models.ForeignKey(User, on_delete=models.CASCADE,
                               related_name="author")
    comment_video = models.ForeignKey(Videos_Posted, on_delete=models.CASCADE,
...
class Profile(models.Model):
    ...
    profile_description = models.CharField(max_length=500,
                                           default="No description")
    videos = models.ManyToManyField(Videos_Posted, related_name="videos",
                                    blank=True)
...
class Subscribers(models.Model):
    follower = models.ForeignKey(User, on_delete=models.CASCADE,
                                 related_name="subfollower")
    creator = models.ForeignKey(User, on_delete=models.CASCADE,
                                related_name="subcreator")
